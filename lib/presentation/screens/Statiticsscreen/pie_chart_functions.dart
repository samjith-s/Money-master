...
void getUsedCategories(List<TransactionModel> _list) {
...
PieChartData incomePieChartData(List<TransactionModel> _list) {
  availableIncomeCategories.clear();
  kv = {};
  getUsedCategories(_list);
...
PieChartData expensePieChartData(List<TransactionModel> _list) {
