...
/// @nodoc
mixin _$LoginState {
  bool get isLogedIn => throw _privateConstructorUsedError;
...
class _$_LoginState implements _LoginState {
  const _$_LoginState({required this.isLogedIn});
  ...
  @override
  String toString() {
    return 'LoginState(isLogedIn: $isLogedIn)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(isLogedIn));
...
abstract class _LoginState implements LoginState {
  const factory _LoginState({required final bool isLogedIn}) = _$_LoginState;
